...
import (
	...
	"github.com/DUBXCOIN/go-dubxcoin/contracts/ens"
	...
	"github.com/DUBXCOIN/go-dubxcoin/swarm"
	bzzapi "github.com/DUBXCOIN/go-dubxcoin/swarm/api"
...
var (
	...
	SwarmSwapAPIFlag = cli.StringFlag{
		Name:  "swap-api",
		Usage: "URL of the dubxcoin API provider to use to settle SWAP payments",
	}
	...
	EnsAPIFlag = cli.StringFlag{
		Name:  "ens-api",
		Usage: "URL of the dubxcoin API provider to use for ENS record lookups",
		Value: node.DefaultIPCEndpoint("gdubx"),
	}
...
// This init function sets defaults so cmd/swarm can run alongside gdubx.
func init() {
...
var app = utils.NewApp(gitCommit, "dubxcoin Swarm")

// This init function creates the cli.App.
func init() {
	app.Action = bzzd
	app.HideVersion = true // we have a command to print the version
	app.Copyright = "Copyright 2013-2016 The go-ethereum / go-dubxcoin Authors"
