...
import (
	...
	"github.com/DUBXCOIN/go-dubxcoin/consensus"
	"github.com/DUBXCOIN/go-dubxcoin/consensus/clique"
	"github.com/DUBXCOIN/go-dubxcoin/consensus/ethash"
	"github.com/DUBXCOIN/go-dubxcoin/core"
	"github.com/DUBXCOIN/go-dubxcoin/core/state"
	"github.com/DUBXCOIN/go-dubxcoin/core/vm"
	"github.com/DUBXCOIN/go-dubxcoin/crypto"
	"github.com/DUBXCOIN/go-dubxcoin/eth"
	"github.com/DUBXCOIN/go-dubxcoin/eth/downloader"
	"github.com/DUBXCOIN/go-dubxcoin/eth/gasprice"
	"github.com/DUBXCOIN/go-dubxcoin/ethdb"
	"github.com/DUBXCOIN/go-dubxcoin/ethstats"
	"github.com/DUBXCOIN/go-dubxcoin/les"
	"github.com/DUBXCOIN/go-dubxcoin/log"
	"github.com/DUBXCOIN/go-dubxcoin/metrics"
	"github.com/DUBXCOIN/go-dubxcoin/node"
	"github.com/DUBXCOIN/go-dubxcoin/p2p"
	"github.com/DUBXCOIN/go-dubxcoin/p2p/discover"
	"github.com/DUBXCOIN/go-dubxcoin/p2p/discv5"
	"github.com/DUBXCOIN/go-dubxcoin/p2p/nat"
	"github.com/DUBXCOIN/go-dubxcoin/p2p/netutil"
	"github.com/DUBXCOIN/go-dubxcoin/params"
	whisper "github.com/DUBXCOIN/go-dubxcoin/whisper/whisperv5"
...
// for Gdubx and returns half of the allowance to assign to the database.
...
func RegisterEthService(stack *node.Node, cfg *eth.Config) {
	...
	if err != nil {
		Fatalf("Failed to register the dubxcoin service: %v", err)
	}
}
...
func RegisterEthStatsService(stack *node.Node, url string) {
	if err := stack.Register(func(ctx *node.ServiceContext) (node.Service, error) {
		...
		Fatalf("Failed to register the dubxcoin Stats service: %v", err)
	}
}
...
// new format.
//
// e.g. gdubx account new --keystore /tmp/mykeystore --lightkdf
//
// is equivalent after calling this method with:
//
// gdubx --keystore /tmp/mykeystore --lightkdf account new
//
