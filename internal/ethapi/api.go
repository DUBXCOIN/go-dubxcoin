...
import (
	...
	"github.com/DUBXCOIN/go-dubxcoin/common/math"
...
func signHash(data []byte) []byte {
	msg := fmt.Sprintf("\x19dubxcoin Signed Message:\n%d%s", len(data), data)
...
//
// https://github.com/DUBXCOIN/go-dubxcoin/wiki/Management-APIs#personal_sign
...
//
// https://github.com/DUBXCOIN/go-dubxcoin/wiki/Management-APIs#personal_ecRecover
func (s *PrivateAccountAPI) EcRecover(ctx context.Context, data, sig hexutil.Bytes) (common.Address, error) {
	if len(sig) != 65 {
		return common.Address{}, fmt.Errorf("signature must be 65 bytes long")
	}
	if sig[64] != 27 && sig[64] != 28 {
		return common.Address{}, fmt.Errorf("invalid dubxcoin signature (V is not 27 or 28)")
	}
