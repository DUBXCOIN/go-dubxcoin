...
import (
	...
	"github.com/DUBXCOIN/go-dubxcoin/common/compiler"
)

var (
	abiFlag = flag.String("abi", "", "Path to the dubxcoin contract ABI json to bind")
	binFlag = flag.String("bin", "", "Path to the dubxcoin contract bytecode (generate deploy method)")
	typFlag = flag.String("type", "", "Struct name for the binding (default = package name)")

	solFlag  = flag.String("sol", "", "Path to the dubxcoin contract Solidity source to build and bind")
