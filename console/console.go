...
import (
	...
	"github.com/DUBXCOIN/go-dubxcoin/internal/jsre"
	"github.com/DUBXCOIN/go-dubxcoin/internal/web3ext"
...
// Welcome show summary of current gdubx instance and some metadata about the
// console's available modules.
func (c *Console) Welcome() {
	// Print some generic gdubx metadata
	fmt.Fprintf(c.printer, "Welcome to the Gdubx JavaScript console!\n\n")
	c.jsre.Run(`
