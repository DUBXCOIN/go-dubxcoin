Name "gdubx ${MAJORVERSION}.${MINORVERSION}.${BUILDVERSION}" # VERSION variables set through command line arguments
InstallDir "$InstDir"
OutFile "${OUTPUTFILE}" # set through command line arguments

# Links for "Add/Remove Programs"
!define HELPURL "https://github.com/DUBXCOIN/go-dubxcoin/issues"
!define UPDATEURL "https://github.com/DUBXCOIN/go-dubxcoin/releases"
!define ABOUTURL "https://github.com/DUBXCOIN/go-dubxcoin#dubxcoin-go
"
...
# Install gdubx binary
Section "Gdubx" GETH_IDX
  SetOutPath $INSTDIR
  file {{.Gdubx}}

  # Create start menu launcher
  createDirectory "$SMPROGRAMS\${APPNAME}"
  createShortCut "$SMPROGRAMS\${APPNAME}\${APPNAME}.lnk" "$INSTDIR\gdubx.exe" "--fast" "--cache=512"
  createShortCut "$SMPROGRAMS\${APPNAME}\Attach.lnk" "$INSTDIR\gdubx.exe" "attach" "" ""
  ...
  # Firewall - add rules
  SimpleFC::AdvAddRule "gdubx incoming peers (TCP:32609)" ""  6 1 1 2147483647 1 "$INSTDIR\gdubx.exe" "" "" "dubxcoin" 32609 "" "" ""
  SimpleFC::AdvAddRule "gdubx outgoing peers (TCP:32609)" ""  6 2 1 2147483647 1 "$INSTDIR\gdubx.exe" "" "" "dubxcoin" "" 32609 "" ""
  SimpleFC::AdvAddRule "gdubx UDP discovery (UDP:32609)" "" 17 2 1 2147483647 1 "$INSTDIR\gdubx.exe" "" "" "dubxcoin" "" 32609 "" ""

  # Set default IPC endpoint (https://github.com/DUBXCOIN/EIPs/issues/147)
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "R" "HKLM" "\\.\pipe\gdubx.ipc"
  ${EnvVarUpdate} $0 "ETHEREUM_SOCKET" "A" "HKLM" "\\.\pipe\gdubx.ipc"
