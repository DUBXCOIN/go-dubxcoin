...
# 1. install gdubx for all users
# 2. install optional development tools such as abigen
# 3. create an uninstaller
# 4. configures the Windows firewall for gdubx
# 5. create gdubx, attach and uninstall start menu entries
...
!define GROUPNAME "Dubxcoin"
!define APPNAME "Gdubx"
!define DESCRIPTION "Official Go implementation of the Dubxcoin protocol"
!addplugindir .\
...
function .onInit
  # make vars are global for all users since gdubx is installed global
