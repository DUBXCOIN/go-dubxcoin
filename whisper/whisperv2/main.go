...
import (
	...
	"github.com/DUBXCOIN/go-dubxcoin/logger"
	"github.com/DUBXCOIN/go-dubxcoin/p2p"
	"github.com/DUBXCOIN/go-dubxcoin/p2p/nat"
	"github.com/DUBXCOIN/go-dubxcoin/whisper"
)
...
func main() {
	...
	fmt.Println("Starting dubxcoin peer...")
	if err := server.Start(); err != nil {
		fmt.Printf("Failed to start dubxcoin peer: %v.\n", err)
		os.Exit(1)
	}
