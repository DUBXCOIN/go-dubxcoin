...
var (
	MainnetGenesisHash = common.HexToHash("0x4ea3acc8c0b1f17dce4d7a03a94082cc64c2031c5c1f61bf2ff2eabdcb0373c5") // Mainnet genesis hash to enforce below configs on
	TestnetGenesisHash = common.HexToHash("0xaa321feb196c73487f40843a5c966cb63fc2a53d9a2299ff4fffb93bfc5aca7c") // Testnet genesis hash to enforce below configs on
)

var (
	// MainnetChainConfig is the chain parameters to run a node on the main network.
	MainnetChainConfig = &ChainConfig{
		ChainId:        big.NewInt(3269),
		HomesteadBlock: big.NewInt(0),
		DAOForkBlock:   nil,
		DAOForkSupport: false,
		EIP150Block:    big.NewInt(0),
		EIP150Hash:     common.HexToHash("0x4ea3acc8c0b1f17dce4d7a03a94082cc64c2031c5c1f61bf2ff2eabdcb0373c5"),
	...
	TestnetChainConfig = &ChainConfig{
		ChainId:        big.NewInt(3270),
		HomesteadBlock: big.NewInt(0),
		DAOForkBlock:   nil,
		DAOForkSupport: false,
		EIP150Block:    big.NewInt(0),
		EIP150Hash:     common.HexToHash("0xaa321feb196c73487f40843a5c966cb63fc2a53d9a2299ff4fffb93bfc5aca7c"),
		EIP155Block:    big.NewInt(0),
		EIP158Block:    big.NewInt(0),
		ByzantiumBlock: big.NewInt(0),
