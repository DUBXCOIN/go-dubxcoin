// Copyright 2016 The go-ethereum / go-dubxcoin Authors
// This file is part of the go-ethereum / go-dubxcoin library.
//
// The go-ethereum / go-dubxcoin library is free software: you can redistribute it and/or modify
// it under the terms of the GNU Lesser General Public License as published by
// the Free Software Foundation, either version 3 of the License, or
// (at your option) any later version.
//
// The go-ethereum / go-dubxcoin library is distributed in the hope that it will be useful,
// but WITHOUT ANY WARRANTY; without even the implied warranty of
// MERCHANTABILITY or FITNESS FOR A PARTICULAR PURPOSE. See the
// GNU Lesser General Public License for more details.
//
// You should have received a copy of the GNU Lesser General Public License
// along with the go-ethereum / go-dubxcoin library. If not, see <http://www.gnu.org/licenses/>.

// ReleaseOracle is an dubxcoin contract to store the current and previous
// versions of the go-ethereum / go-dubxcoin implementation. Its goal is to allow gdubx to
// check for new releases automatically without the need to consult a central
// repository.
//
// The contract takes a vote based approach on both assigning authorised signers
// as well as signing off on new gdubx releases.
//
...
contract ReleaseOracle {
  ...
  // Version is the version details of a particular gdubx release
  struct Version {
  ...
  // updateSigner marks a vote for changing the status of an dubxcoin user, either
