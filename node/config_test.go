...
func TestIPCPathResolution(t *testing.T) {
	var tests = []struct {
		...
		{"", "", false, ""},
		{"data", "", false, ""},
		{"", "gdubx.ipc", false, filepath.Join(os.TempDir(), "gdubx.ipc")},
		{"data", "gdubx.ipc", false, "data/gdubx.ipc"},
		{"data", "./gdubx.ipc", false, "./gdubx.ipc"},
		{"data", "/gdubx.ipc", false, "/gdubx.ipc"},
		{"", "", true, ``},
		{"data", "", true, ``},
		{"", "gdubx.ipc", true, `\\.\pipe\gdubx.ipc`},
		{"data", "gdubx.ipc", true, `\\.\pipe\gdubx.ipc`},
		{"data", `\\.\pipe\gdubx.ipc`, true, `\\.\pipe\gdubx.ipc`},
	}
