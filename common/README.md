...
[![Build
Status](https://travis-ci.org/DUBXCOIN/go-dubxcoin.png?branch=master)](https://travis-ci.org/DUBXCOIN/go-dubxcoin)

The common package contains the dubxcoin utility library.

# Installation

As a subdirectory the main go-dubxcoin repository, you get it with
`go get github.com/DUBXCOIN/go-dubxcoin`.

# Usage

## RLP (Recursive Linear Prefix) Encoding

RLP Encoding is an encoding scheme used by the dubxcoin project. It
encodes any native value or list to a string.

More in depth information about the encoding scheme see the
[Wiki](http://wiki.dubxcoin.tech/index.php/RLP) article.
...
found on the [Wiki](http://wiki.dubxcoin.tech/index.php/Patricia_Tree).
